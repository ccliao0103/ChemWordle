...
// 月份選單:2026 競賽期(4-6 月)+ 常駐練習模式開始後的每個月。
// 動態產生,不然每過一個月就要改程式。
function buildMonths() {
  const out = [
    { value: '2026-04-01', label: '2026 / 4(試營運)' },
    { value: '2026-05-01', label: '2026 / 5(競賽期)' },
    { value: '2026-06-01', label: '2026 / 6(競賽期)' }
  ];
  const now = new Date();
  // 練習模式自 2026-09 起
  let y = 2026, m = 9;
...
const AVAILABLE_MONTHS = buildMonths();

function defaultMonth() {
  return AVAILABLE_MONTHS[AVAILABLE_MONTHS.length - 1].value;
}
